...
<head>
  ...
  <title>PMTV – Chapitre {num:02d}</title>
...
{options}
  ...
  <main>
    <article>
      <h1>Chapitre {num:02d} – Titre à définir</h1>
      <p>Contenu du chapitre {num:02d} à rédiger.</p>
    </article>
  </main>

  <footer>
    <a class="nav-left" href="{prev_link}">← Chapitre précédent</a>
    <a class="nav-right" href="{next_link}">Chapitre suivant →</a>
  </footer>
